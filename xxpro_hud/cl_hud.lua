local function Base()
	...
	draw.RoundedBox(6, ScrW() - 1250 - 10, ScrH () - 130 - 10, 350, 125, Color(255, 255, 255, 150))

	draw.DrawText( "© xXPro-BakeR HUD's", "BakersFont", ScrW() - 1250, ScrH () - 138, Color(70, 70, 70, 255))

---------------------------------------------------------------------------
-- Health
---------------------------------------------------------------------------

	draw.RoundedBox(6, ScrW() - 1250, ScrH () - 75, 350-20, 20, Color(0, 0, 0, 150))
	...
	if DrawHealth < 0 then DrawHealth = 1 end


	draw.RoundedBox(6, ScrW() - 1250, ScrH () - 75, (350-20) * DrawHealth / 100, 20, Color(255, 0, 0, 150))

    draw.DrawText( "Health:"..EchoHealth, "Trebuchet24", ScrW() - 1250 + 4, ScrH () - 75 - 2, Color(70, 70, 70,255))
...
---------------------------------------------------------------------------
	...
	draw.RoundedBox(6, ScrW() - 1250, ScrH () - 50, 350-20, 20, Color(0, 0, 0, 150))
	...
	draw.RoundedBox(6, ScrW() - 1250, ScrH () - 50, (350-20) * DrawHealth / 100, 20, Color(0,255,0,150))

    draw.DrawText( "Armor:"..EchoHealth, "Trebuchet24", ScrW() - 1250 + 4, ScrH () - 50 - 2, Color(70, 70, 70,255))

---------------------------------------------------------------------------
-- Thin Line
---------------------------------------------------------------------------

	draw.RoundedBox(0, ScrW() - 1250, ScrH () - 105, 300 + 30, 2, Color(155, 100, 0, 255))

---------------------------------------------------------------------------
-- Player Name
---------------------------------------------------------------------------

	draw.DrawText( LocalPlayer():Nick(), "ChatFont", ScrW() - 1250 + 3, ScrH () - 105 + 3, Color(0, 0, 255, 255))

---------------------------------------------------------------------------
-- Job
---------------------------------------------------------------------------

	draw.DrawText( "Job: "..LocalPlayer():getDarkRPVar( "job" ), "ChatFont", ScrW() - 1225 + 160, ScrH () - 105 + 3, Color(0, 0, 255, 255))

---------------------------------------------------------------------------
-- Salary
---------------------------------------------------------------------------

	draw.DrawText( "Sallary: "..LocalPlayer():getDarkRPVar( "salary" ), "ChatFont", ScrW() - 1250 + 3, ScrH () - 115 - 7, Color(0, 0, 255, 255))

---------------------------------------------------------------------------
-- Money
---------------------------------------------------------------------------

	draw.DrawText( "Wallet: $"..LocalPlayer():getDarkRPVar( "money" ), "ChatFont", ScrW() - 1225 + 160, ScrH () - 115 - 7, Color(0, 0, 255, 255))
